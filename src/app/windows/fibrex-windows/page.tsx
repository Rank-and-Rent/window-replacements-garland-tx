  ...
  const content = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Fibrex windows capture the natural warmth and character of real wood while eliminating the maintenance headaches that plague traditional wood windows in Garland. The material accepts stains and finishes that replicate authentic wood tones, from golden oak to deep walnut, creating seamless continuity with Garland&apos;s historic architecture. Unlike wood windows that require annual painting and sealing in Garland&apos;s climate, Fibrex maintains its finish indefinitely without fading or weathering. Homeowners can enjoy the traditional appeal of wood windows—the natural grain patterns, the tactile warmth—without the time, expense, and environmental impact of maintaining authentic wood in Garland&apos;s demanding environment.",
      },
      {
        heading: 'Structural Superiority for Garland Homes',
        content: "Fibrex&apos;s composite construction delivers strength that surpasses both wood and vinyl alternatives, making it ideal for Garland&apos;s diverse housing stock. The material resists impact damage from severe weather, hail, or accidental impacts far better than traditional wood. Fibrex frames maintain perfect alignment and smooth operation even in Garland&apos;s temperature extremes, where wood might warp and vinyl might become brittle. The material&apos;s dimensional stability ensures weatherstripping maintains perfect contact year-round, preventing air infiltration that compromises energy efficiency. For Garland homeowners who demand quality and longevity, Fibrex provides the structural integrity required for windows that perform flawlessly in Texas weather.",
      },
      {
        heading: 'Energy Performance That Saves in Garland Climate',
        content: "Fibrex&apos;s unique material properties create exceptional thermal performance that delivers measurable savings in Garland&apos;s hot climate. The wood fiber content provides natural insulation, while the polymer matrix prevents heat conduction, resulting in U-factors that rival premium fiberglass. When combined with Andersen&apos;s advanced multi-pane insulated glass, Fibrex windows can reduce heating and cooling costs by 30-40% compared to older windows. The material&apos;s stability ensures optimal weatherstripping performance year-round, maintaining energy efficiency even during Garland&apos;s dramatic temperature swings. Many Fibrex window configurations qualify for energy rebates, making them an economical choice despite their premium positioning.",
      },
      {
        heading: 'Design Flexibility for Garland Architecture',
        content: "Fibrex&apos;s workability allows it to be formed into virtually any window style and configuration, making it ideal for Garland&apos;s architectural diversity. The material can be stained to match traditional wood tones for historic Garland homes or finished in contemporary colors for modern developments. Fibrex accommodates complex custom designs that would be difficult with other materials, from arched windows in historic restorations to large fixed panels in contemporary architecture. The material&apos;s strength enables innovative applications while maintaining the wood-like aesthetics that Garland homeowners value. Whether preserving architectural heritage or embracing modern design, Fibrex provides the versatility required in Garland&apos;s diverse real estate market.",
      },
      {
        heading: 'Environmental Responsibility and Longevity',
        content: "Fibrex represents a sustainable approach to window manufacturing that resonates with Garland&apos;s growing environmental consciousness. The wood fiber content comes from responsibly harvested sources, and the advanced polymer technology reduces the environmental impact compared to traditional wood treated with chemical preservatives. Fibrex windows require no toxic sealants or paints, maintaining their appearance naturally. The exceptional longevity means fewer replacements over time, reducing material consumption and landfill impact. For environmentally aware Garland homeowners, Fibrex windows provide premium performance with a significantly lower ecological footprint than traditional wood windows, supporting the city&apos;s commitment to sustainable development.",
      },
    ],
    ...
    faq: [
      ...
      {
        question: 'How long do Fibrex windows last in Garland?',
