...
export default function WoodWindowsPage() {
  const content = {
    title: 'Wood Windows Replacement in Garland, TX',
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Wood is naturally insulating, providing thermal performance that rivals modern synthetics without requiring complex engineering. The cellular structure creates air pockets that resist heat transfer, keeping Garland homes comfortable year-round. Quality wood windows achieve U-factors of 0.25-0.30, comparable to premium alternatives, while providing the added benefit of thermal mass that moderates temperature swings throughout the day.",
      },
      {
        heading: 'Exceptional Craftsmanship and Quality',
        content: "Solid wood windows represent traditional craftsmanship at its finest. Quality manufacturers select premium wood species—mahogany, oak, cherry, or pine—and craft windows using time-honored joinery techniques. The result is windows that operate smoothly, align perfectly, and provide decades of service. For Garland homeowners who appreciate quality construction, wood windows offer satisfaction that mass-produced alternatives cannot match.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'With proper maintenance, quality wood windows last 50-100 years or more. They can be refinished repeatedly, allowing homeowners to refresh appearance without replacement. Many Garland homes feature original wood windows from the 1920s-1940s.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Many Garland historic districts require wood windows to maintain period authenticity. Even when not mandated, wood windows are essential for authentic historic preservation and maintaining property value in historic neighborhoods.',
      },
      {
