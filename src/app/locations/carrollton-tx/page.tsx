...
export const metadata: Metadata = {
  ...
  description: "Professional window replacement throughout Carrollton, TX. Serving all Carrollton neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-734-3158",
  keywords: "window replacement Carrollton TX, Carrollton window installation, Carrollton windows",
};
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-navy-900">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-24">
          ...
          <p className="text-xl text-cream-200 mb-8 max-w-2xl mx-auto">
            Serving Carrollton homeowners with premium window installation services from your trusted Garland-based experts.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">
                Expert Window Services Throughout Carrollton
              </h2>
              <p className="text-navy-700 leading-relaxed mb-6">
                Carrollton's residential landscape features both established neighborhoods and newer master-planned communities. From the historic charm of Old Town Carrollton to the modern amenities of Carrollton City Place, we understand the architectural diversity that makes each home unique.
              </p>
              <p className="text-navy-700 leading-relaxed mb-6">
                Our Garland-based team brings extensive experience and factory-trained expertise to every Carrollton project.
