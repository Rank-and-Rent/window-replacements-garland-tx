...
export const metadata: Metadata = {
  title: "Window Replacement Seagoville TX | Premium Installation Services",
  description: "Professional window replacement throughout Seagoville, TX. Serving all Seagoville neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-734-3158",
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-navy-900">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-24">
          ...
          <p className="text-xl text-cream-200 mb-8 max-w-2xl mx-auto">
            Serving Seagoville homeowners with premium window installation services from your trusted Garland-based experts.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">
                Expert Window Services Throughout Seagoville
              </h2>
              <p className="text-navy-700 leading-relaxed mb-6">
                Seagoville's historic downtown and growing residential areas require window solutions that balance preservation with modern performance. Our team understands Seagoville's unique architectural character and climate considerations.
              </p>
              <p className="text-navy-700 leading-relaxed mb-6">
                Our Garland-based team brings extensive experience and factory-trained expertise to every Seagoville project.
