...
export const metadata: Metadata = {
  title: "Window Replacement Heath TX | Premium Installation Services",
  description: "Professional window replacement throughout Heath, TX. Serving all Heath neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-734-3158",
  keywords: "window replacement Heath TX, Heath window installation, Heath windows",
};
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-navy-900">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-24">
          ...
          <p className="text-xl text-cream-200 mb-8 max-w-2xl mx-auto">
            Serving Heath homeowners with premium window installation services from your trusted Garland-based experts.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">
                Expert Window Services Throughout Heath
              </h2>
              <p className="text-navy-700 leading-relaxed mb-6">
                Heath's master-planned community features high-end homes that require sophisticated window solutions. Our Garland-based experts deliver installations that meet Heath's architectural standards.
              </p>
              <p className="text-navy-700 leading-relaxed mb-6">
                Our Garland-based team brings extensive experience and factory-trained expertise to every Heath project.
