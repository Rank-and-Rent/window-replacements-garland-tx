...
export const metadata: Metadata = {
  title: "Window Replacement North Garland TX | Premium Installation Services",
  description: "Professional window replacement throughout North Garland, TX. Serving all North Garland neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-734-3158",
  keywords: "window replacement North Garland TX, North Garland window installation, North Garland windows",
};
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-navy-900">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-24">
          ...
          <p className="text-xl text-cream-200 mb-8 max-w-2xl mx-auto">
            Serving North Garland homeowners with premium window installation services from your trusted local experts.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">
                Expert Window Services in North Garland
              </h2>
              <p className="text-navy-700 leading-relaxed mb-6">
                North Garland's diverse housing stock includes everything from established neighborhoods to newer developments. We understand North Garland's unique architectural character and provide tailored window solutions.
              </p>
              <p className="text-navy-700 leading-relaxed mb-6">
                Our Garland-based team brings extensive experience and factory-trained expertise to every North Garland project.
