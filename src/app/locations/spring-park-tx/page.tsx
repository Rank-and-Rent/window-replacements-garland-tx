...
export const metadata: Metadata = {
  title: "Window Replacement Spring Park TX | Premium Installation Services",
  description: "Professional window replacement throughout Spring Park, TX. Serving all Spring Park neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-734-3158",
  keywords: "window replacement Spring Park TX, Spring Park window installation, Spring Park windows",
};
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-navy-900">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-24">
          ...
          <p className="text-xl text-cream-200 mb-8 max-w-2xl mx-auto">
            Serving Spring Park homeowners with premium window installation services from your trusted local experts.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="font-serif text-3xl font-semibold text-navy-900 mb-6">
                Expert Window Services in Spring Park
              </h2>
              <p className="text-navy-700 leading-relaxed mb-6">
                Spring Park's residential community benefits from our specialized knowledge of Garland-area home construction. We provide window solutions that enhance comfort and energy efficiency throughout Spring Park.
              </p>
              <p className="text-navy-700 leading-relaxed mb-6">
                Our Garland-based team brings extensive experience and factory-trained expertise to every Spring Park project.
