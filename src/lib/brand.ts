...
export function getBrand() {
  return {
    ...
    logo_url: `${CANONICAL_URL}window-replacement-service-garland-tx.png`,
    ...
    brand_tagline: 'Premium Window & Door Installation in Garland, TX',
    supportPhone: PHONE,
    supportEmail: EMAIL,
    service_area: 'Serving Garland and the Greater DFW Metroplex',
  };
}
